...
$(document).ready(function() {
    ...
    var adicionaBotaoCompartilhaco = function(comissao, deputados, grupo) {
        ...
        if (element.length > 0) {
          ...
          subject = 'Reforma da Previdência';
          body = 'Excelentíssimo(a) Senhor(a) Deputado(a) Federal,%0D%0A%0D%0A\n' +
          'Gostaria de contar com o apoio de V.Exa. no sentido de garantir que não sejam retirados direitos dos trabalhadores brasileiros na reforma da Previdência Social (PEC 287/16) patrocinada pelo governo federal, rejeitando na íntegra a proposta governamental.%0D%0A%0D%0A\n' +
